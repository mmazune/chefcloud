...
fs.writeFileSync('reports/artifacts/epics_matrix.json', JSON.stringify(epicsMatrix, null, 2));
console.log('Epics matrix created');
console.log(`Total epics analyzed: ${epicsMatrix.epics.length}`);
console.log(`Status summary:`);
epicsMatrix.epics.forEach(e => console.log(`  ${e.id}: ${e.status} ${e.name}`));
