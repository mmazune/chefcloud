...
| Issue ID | Category | Summary | Impact | Log Link |
|----------|----------|---------|--------|----------|
| [PRE-001](PRE_EXISTING_ISSUES_LOG.md#pre-001-eslint-warnings--api-service-120-warnings) | lint-warning | 120 ESLint warnings in API service (unused vars) | Low | [Link](PRE_EXISTING_ISSUES_LOG.md#pre-001-eslint-warnings--api-service-120-warnings) |
| [PRE-002](PRE_EXISTING_ISSUES_LOG.md#pre-002-eslint-errors--web-app-2-errors--16-warnings) | lint-error | 2 ESLint errors + 16 warnings in web app | Medium | [Link](PRE_EXISTING_ISSUES_LOG.md#pre-002-eslint-errors--web-app-2-errors--16-warnings) |
| [PRE-003](PRE_EXISTING_ISSUES_LOG.md#pre-003-e2e-teardown-check-warnings-2-warnings) | test-warning | 2 E2E teardown check warnings (false positive) | Low | [Link](PRE_EXISTING_ISSUES_LOG.md#pre-003-e2e-teardown-check-warnings-2-warnings) |
...
| `pnpm -C apps/web lint` | 60s | 2 errors, 16 warnings (exit code 1) |
